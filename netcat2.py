...
# this is a python tool to replicate the functionality of netcat
...
def usage():
	...
	print('echo \'ABCDEFGHI\' | ./netcat2.py -t 192.168.11.12 -p 135')
	sys.exit(0)
...
def client_handler(client_socket):
	...
	if len(upload_destination):
		...
		# keep reading data until no more
		while True:
		...
		# now take these bytes and try to write out
		try:
			file_descriptor = open(upload_destination, "wb")
			file_descriptor.write(file_buffer)
			file_descriptor.close()

			# acknowledge file writing
